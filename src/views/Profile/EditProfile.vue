<template>
    <div
        class="mt-41 ml-200 font-marck-script font-serif text-[50px] text-black mb-30 md:mt-41 md:ml-75 text-center"
    >
        {{ $t("profile.title") }}
    </div>
    <div
    ...
    >
        ...
        >
            <div
                class="flex justify-between lg:justify-center gap-8 lg:w-full flex-wrap lg:flex-nowrap"
            >
                <input-text
                    v-model="data.name"
                    :value="database.state.data?.reloadUserInfo?.displayName"
                ...
                <input-text
                    v-model="data.email"
                    :value="database.state.data?.reloadUserInfo?.email"
                    class="focus:ring-0 focus:ring-offset-0 w-full"
                >
                    {{ $t("profile.email") }}
                </input-text>
            ...
            <button
                class="red-btn max-w-[400px] w-full mx-auto mb-5"
                @click="onSubmit"
            >
