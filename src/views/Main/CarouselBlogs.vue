        ...
        <div class="blog">
          ...
          <div class="blog__footer">
            <div class="blog__date">
              <img src="../../assets/images/svg/calendar.svg" class="blog__date-calendar" />
              <span class="blog__date-text">{{ slide.date }}</span>
            </div>
            <button class="flex items-center text-main-color">
              {{ $t("blog.blogBtnText") }}
              <img src="../../assets/images/svg/arrow-img.svg" alt="" class="ms-2 mt-1" />
            </button>
          </div>
        </div>
      </div>
...
const getImageUrl = (url: string) => {
  return new URL(`../../assets/images/jpg/main/blogs/${url}.jpg`, import.meta.url).href;
};
</script>
