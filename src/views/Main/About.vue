<template>
  <article class="relative w-full">
    ...
    />
    <h4 class="text-main-color text-center text-xl uppercase font-medium">
      {{ $t("about.subTitle") }}
    </h4>
    <h2
      class="font-marck-script text-black text-center text-[24px] lg:text-[54px]"
    >
      {{ $t("about.title") }}
    </h2>
    ...
    <div
      class="px-5 flex gap-5 flex-wrap items-center justify-center max-w-[900px] mx-auto lg:flex-nowrap lg:gap-0"
      data-aos="zoom-in-up"
    >
